      ...
      <div className="max-w-md w-full space-y-8 z-10">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-500 dark:text-slate-400">
            Start managing environment variables securely in seconds.
          </p>
        </div>
        ...
        <div className="bg-white/80 dark:bg-[#111827]/80 backdrop-blur-md border border-gray-200/60 dark:border-slate-800/60 rounded-2xl shadow-xl p-8 space-y-6">
          <form className="space-y-5" onSubmit={handleSubmit}>
            {error && (
              <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-900 text-red-650 dark:text-red-400 px-4 py-3 rounded-lg text-sm font-medium">
                {error}
              </div>
            )}
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="block w-full pl-10 pr-3 py-2 border border-gray-255 dark:border-slate-800 rounded-lg bg-white dark:bg-slate-900 text-sm placeholder-gray-400 text-gray-900 dark:text-white focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
              ...
              <div>
                <label htmlFor="password" className="block text-xs font-bold text-gray-400 dark:text-slate-500 uppercase tracking-wider mb-1.5">
                  Password
                </label>
                <div className="relative">
                  <input
                    ...
                    className="block w-full pl-10 pr-10 py-2 border border-gray-255 dark:border-slate-800 rounded-lg bg-white dark:bg-slate-900 text-sm placeholder-gray-400 text-gray-900 dark:text-white focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
              ...
              <div>
                <label htmlFor="confirmPassword" className="block text-xs font-bold text-gray-400 dark:text-slate-500 uppercase tracking-wider mb-1.5">
                  Confirm Password
                </label>
                <div className="relative">
                  <input
