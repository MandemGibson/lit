              ...
              <div className="pt-2 flex flex-col gap-3">
                ...
                <div className="flex justify-between text-xs pt-2">
                  <button
                    ...
                    disabled={isLoading}
                    className="font-bold text-cyan-400 hover:text-cyan-300 transition-colors disabled:opacity-50"
                  >
                    Resend Code
                  </button>
                  <button
              ...
              <div className="space-y-4">
                ...
                <div>
                  <div className="flex justify-between items-center mb-1.5">
                    ...
                    <Link
                      to="/forgot-password"
                      className="text-[10px] font-bold text-cyan-400 hover:text-cyan-300 font-sans transition-colors"
                    >
                      Forgot password?
                    </Link>
                  </div>
